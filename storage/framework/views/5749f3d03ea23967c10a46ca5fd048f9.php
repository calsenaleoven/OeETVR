                ...
                <tbody>
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($totalTasks); ?></td>
                            <td><?php echo e($completedTasks); ?></td>
                            <td style="width: 40%;">
                                <div class="progress" style="height: 10px; border-radius: 5px;">
                                    <div class="progress-bar <?php echo e($totalPercentage >= 75 ? 'bg-dark' : ($totalPercentage >= 50 ? 'bg-success' : ($totalPercentage >= 25 ? 'bg-info' : 'bg-secondary'))); ?>"
                                         role="progressbar"
                                         style="width: <?php echo e($totalPercentage); ?>%; color: white;"
                                         aria-valuenow="<?php echo e($totalPercentage); ?>" aria-valuemin="0" aria-valuemax="100">
                                         <?php echo e(round($totalPercentage)); ?>%
                                    </div>
                                </div>
                            </td>
                            <td>
...
<?php echo $__env->make('templates.admin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u382238056/domains/constructflow-oetvr.com/public_html/resources/views/admin/reports/view-reports.blade.php ENDPATH**/ ?>