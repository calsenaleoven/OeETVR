...
<footer class="footer text-center mt-4 p-3" style="background-color: #6A9C89; color: #E9EFEC; padding-bottom: 70px;">
    <div class="container">
        <p class="mb-0">Copyright &copy; <?php echo e(date('Y')); ?> ETVR Construction and Trading. All Rights Reserved.</p>
...
<?php /**PATH /home/u382238056/domains/constructflow-oetvr.com/public_html/resources/views/templates/member/footer.blade.php ENDPATH**/ ?>