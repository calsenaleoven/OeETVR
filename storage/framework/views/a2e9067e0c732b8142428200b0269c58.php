    ...
    <div class="container-fluid mt-2" style="background-color: #C4DAD2;">
        <div class="card shadow-sm border-0" style="border-radius: 15px; background-color: #E9EFEC;">
            <div class="card-header py-3" style="background-color: #6A9C89; border-radius: 15px 15px 0 0;">
                <h4 class="text-white">
                    All Projects
                    <a href="<?php echo e(route('admin.create-project')); ?>" class="btn float-right text-white" style="background-color: #16423C; border-radius: 20px;">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" style="background-color: #E9EFEC;">
                                            ...
                                            <button type="button" class="dropdown-item" style="color: #16423C;" 
                                                    data-toggle="modal" data-target="#confirmDeleteModal_<?php echo e($row->id); ?>">Delete</button>
                                        </div>
...
<?php echo $__env->make('templates.admin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u382238056/domains/constructflow-oetvr.com/public_html/resources/views/admin/projects/view-projects.blade.php ENDPATH**/ ?>