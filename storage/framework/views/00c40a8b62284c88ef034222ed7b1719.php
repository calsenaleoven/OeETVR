            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0 mb-4" style="background-color: #E9EFEC ; border-radius: 15px;">
                    <div class="card-body p-4">
                        <h2 class="h4 mb-0" style="color: #16423C ;">Welcome back, <?php echo e($user = auth()->user()->fullname); ?>! 👋</h2>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-white"><?php echo e($totalProjects); ?></h3>
                                    </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-white"><?php echo e($allTasks); ?></h3>
                                    </div>
                                    <div class="rounded-circle p-3" style="background-color: rgba(255,255,255,0.2);">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 40%;">
                                                <div class="progress" style="height: 10px; border-radius: 5px;">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="progress-bar" role="progressbar"
                                                            style="width: <?php echo e($row->totalPercentage); ?>%; 
                                                                   background-color: <?php echo e($row->totalPercentage >= 75 ? '#16423C ' : 
                                                                   ($row->totalPercentage >= 50 ? '#6A9C89 ' : 
                                                                   ($row->totalPercentage >= 25 ? '#C4DAD2' : '#E9EFEC '))); ?>;"
                                                            aria-valuenow="<?php echo e($row->totalPercentage); ?>" 
                                                            aria-valuemin="0"
                            ...
                            <table id="example1" class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($feedback->project->project_name); ?></td>
                                            <td><?php echo e($feedback->member->fullname); ?></td>
                                            <td><?php echo e($feedback->rating); ?></td>
                                            <td><?php echo e($feedback->comment); ?></td>
                                            <td><?php echo e($feedback->created_at->format('F d, Y')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('templates.admin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u382238056/domains/constructflow-oetvr.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>