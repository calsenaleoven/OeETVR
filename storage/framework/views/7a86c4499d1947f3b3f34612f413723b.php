...
<?php $__env->startSection('content'); ?>
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0" style="color: #16423C;">Edit Project Details / <?php echo e($details->project_name); ?></h1>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="Pending" <?php echo e($details->status === 'Pending' ? 'selected' : ''); ?>>Pending</option>
                                    <option value="On-hold" <?php echo e($details->status === 'On-Hold' ? 'selected' : ''); ?>>On-Hold</option>
                                    <option value="On-going" <?php echo e($details->status === 'On-going' ? 'selected' : ''); ?>>On-going</option>
                                    <option value="Done" <?php echo e($details->status === 'Done' ? 'selected' : ''); ?>>Done</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="Kalsada" <?php echo e($details->category == 'Kalsada' ? 'selected' : ''); ?>>Kalsada</option>
                                    <option value="Highway" <?php echo e($details->category == 'Highway' ? 'selected' : ''); ?>>Highway</option>
                                    <option value="Bridge" <?php echo e($details->category == 'Bridge' ? 'selected' : ''); ?>>Bridge</option>
                                    <option value="Government Facilities"
                                        <?php echo e($details->category == 'Government Facilities' ? 'selected' : ''); ?>>Government Facilities</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer" style="background-color: #E9EFEC; border-color: #C4DAD2 !important;">
                        <div class="d-flex w-100 justify-content-start align-items-center">
                            ...
                            <a class="btn btn-warning mx-2" href="<?php echo e(route('admin.view-projects')); ?>">Discard Changes</a>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('templates.admin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u382238056/domains/constructflow-oetvr.com/public_html/resources/views/admin/projects/edit-details.blade.php ENDPATH**/ ?>