...
Route::middleware(['auth', 'isOwner'])->group(function () {
    ...
    Route::post('/owner/project-feedback', [ProjectController::class, 'submitFeedback'])->name('owner.project-feedback');
});
...
Route::middleware(['auth', 'isMember'])->group(function () {
    ...
    Route::post('member/projects/task-list', [MemberController::class, 'updateStatus'])->name('member.task-list');
});
...
Route::middleware(['auth', 'isManager'])->group(function () {
    ...
    Route::get('/manager/projects/task-list',[ManagerController::class,'tasks'])->name('manager.task-list');
    Route::post('manager/projects/task-list', [ManagerController::class, 'updateStatus'])->name('manager.task-list');
